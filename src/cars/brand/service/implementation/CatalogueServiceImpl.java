...
public class CatalogueServiceImpl implements CatalogueService {
    ...
    public Vehicle createElectricCar() {
        ...
        short enginePower;
        System.out.print("Enter power of the engine(W): ");
        enginePower = scanner.nextShort();

        int batteryCapacity;
        System.out.print("Enter capacity of the battery(Ah): ");
        batteryCapacity = scanner.nextInt();

        double price;
        System.out.print("Enter the price(euro): ");
    ...
    public Vehicle createGasCar() {
        ...
        System.out.print("Enter the engine displacement(L): ");
        engineDisplacement = scanner.nextFloat();

        short enginePower;
        System.out.print("Enter power of the engine(KW): ");
        enginePower = scanner.nextShort();
